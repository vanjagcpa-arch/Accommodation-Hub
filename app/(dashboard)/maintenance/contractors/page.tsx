      ...
      <div className="border-b border-line bg-surface px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-ink-muted">Manage maintenance contractors and trade contacts</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-surface-muted">
            <Users className="h-8 w-8 text-ink-subtle" />
          </div>
          <h2 className="mb-1 text-base font-medium text-ink">Coming soon</h2>
          <p className="text-sm text-ink-muted">
            Contractor profiles, trade categories and job history will appear here.
          </p>
        </div>
      </div>
    </div>
