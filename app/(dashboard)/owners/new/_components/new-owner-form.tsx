...
import { createOwner, type ActionState } from '@/lib/owners/actions'

export function NewOwnerForm() {
  const [state, formAction, pending] = useActionState<ActionState, FormData>(createOwner, { error: null })
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Input id="company_name" name="company_name" placeholder="If owner is a company or trust" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
      ...
      <div className="flex items-center justify-end gap-3 pb-4">
        ...
        <Button type="submit" loading={pending}>Add Owner</Button>
      </div>
    </form>
  )
}
